...
import { ValidateUserDataService } from '../../../../../src/contexts/accounts/services/auth/validation'
...
vi.mock('../../../../../src/contexts/accounts/services/auth/validation', () => {
  return {
...
vi.mock(
  '../../../../../src/contexts/accounts/services/auth/verify-credentials',
  () => {
    return {
